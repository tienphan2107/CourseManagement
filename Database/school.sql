...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 25, 2024 lúc 08:13 AM
...
ALTER TABLE `courseinstructor`
  ...
  ADD KEY `Fk_StudentID_CourseInstructor` (`PersonID`);
...
ALTER TABLE `courseinstructor`
  ...
  ADD CONSTRAINT `Fk_StudentID_CourseInstructor` FOREIGN KEY (`PersonID`) REFERENCES `person` (`PersonID`);

--
-- Các ràng buộc cho bảng `officeassignment`
--
ALTER TABLE `officeassignment`
  ADD CONSTRAINT `Fk_InstructorID_OfficeAssignment` FOREIGN KEY (`InstructorID`) REFERENCES `person` (`PersonID`);
...
--
ALTER TABLE `onsitecourse`
  ADD CONSTRAINT `Fk_CourseID_OnsiteCourse` FOREIGN KEY (`CourseID`) REFERENCES `course` (`CourseID`);

--
-- Các ràng buộc cho bảng `studentgrade`
--
ALTER TABLE `studentgrade`
  ADD CONSTRAINT `Fk_CourseID_StudentGrade` FOREIGN KEY (`CourseID`) REFERENCES `course` (`CourseID`),
  ADD CONSTRAINT `Fk_StudentID_StudentGrade` FOREIGN KEY (`StudentID`) REFERENCES `person` (`PersonID`);
COMMIT;
